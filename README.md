<p align="center">
  <img src="https://github.com/RoiAzrai/RoiAzrai/blob/main/DallE03.6.png" alt="Colorful abstract digital artwork" style="width: 100%; max-width: 1500px;"/>
</p>
...
A full-stack web application that enables users to search, filter, and browse movies using the TMDB API, built with a Flask backend and a JavaScript frontend. Features include real-time search suggestions, genre filtering, pagination, and a responsive UI.
...
![Power Query](https://img.shields.io/badge/-Power_Query-FAFAFA?style=flat-square&logo=microsoft&logoColor=black)
